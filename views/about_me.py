...
with col1:
    st.image(r'G:\My Drive\Python\personal website\assets\IMG_1898-EDIT-EDIT.jpg', use_container_width=True, caption='Grand Canyon, South Rim, April 2024',clamp=False)
...
''')
    ...
    with open(r'G:\My Drive\Python\personal website\assets\Resume_2025_Temchin.docx.pdf','rb') as resume:
        pdfbyte = resume.read()
        st.download_button(
            label='📃 Remediation Resume (pdf)', data=pdfbyte, file_name='Temchin Resume, env remediation.pdf',mime='application/octet-stream')

    with open(r'G:\My Drive\Python\personal website\assets\Copy of OSHA_40-hour_2011-2012.pdf', 'rb') as hazwoper:
